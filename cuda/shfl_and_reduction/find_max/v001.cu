...
// bs 2014 
//----------------------------------------------------------------------------//
__global__ void kernel_find_max_1024(const float* __restrict__ A,
...
// bs 512 
//----------------------------------------------------------------------------//
__global__ void kernel_find_max_512(const float* __restrict__ A,
		const int warp_per_blk,
		const int datasize,
		float *A_max)
{
...
// bs 256 
//----------------------------------------------------------------------------//
__global__ void kernel_find_max_256(const float* __restrict__ A,
		const int warp_per_blk,
		const int datasize,
		float *A_max)
{
...
// bs 128 
//----------------------------------------------------------------------------//
__global__ void kernel_find_max_128(const float* __restrict__ A,
		const int warp_per_blk,
		const int datasize,
		float *A_max)
{
...
// bs 64 
//----------------------------------------------------------------------------//
__global__ void kernel_find_max_64(const float* __restrict__ A,
		const int warp_per_blk,
		const int datasize,
		float *A_max)
{
	...
	// max 2 warps
	if(lx == 0) {
		atomic_max(A_max, fmaxf(sdata[0], sdata[1]));
	}
}
