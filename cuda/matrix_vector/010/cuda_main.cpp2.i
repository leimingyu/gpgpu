...
# 160 "/usr/local/cuda/include/device_functions.h"
...
# 105 "cuda_main.cu"
__attribute__((global)) extern void _Z17kernel_sgemv_128biiiPKfS0_Pf(const int, const int, const int, const float *__restrict__, const float *__restrict__, float *__restrict__);
...
# 105 "cuda_main.cu"
__attribute__((global)) void _Z17kernel_sgemv_128biiiPKfS0_Pf(
# 105 "cuda_main.cu"
const int rows,
# 106 "cuda_main.cu"
const int cols,
...
{
# 113 "cuda_main.cu"
  __attribute__((shared)) float __cuda_local_var_75868_32_non_const_sb[128];
# 115 "cuda_main.cu"
