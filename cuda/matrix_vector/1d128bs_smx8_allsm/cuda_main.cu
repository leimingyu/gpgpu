		...
		float* __restrict__ C)
{
	...
	__shared__ float A4_sm[128];
	__shared__ float A5_sm[128];
	__shared__ float A6_sm[128];
	__shared__ float A7_sm[128];
	...
	A4_sm[lx]  = A[startpos4 + lx];
	A5_sm[lx]  = A[startpos5 + lx];
	A6_sm[lx]  = A[startpos6 + lx];
	A7_sm[lx]  = A[startpos7 + lx];
