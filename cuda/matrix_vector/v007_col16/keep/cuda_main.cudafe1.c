...
# 84 "cuda_main.cu"
extern void _Z8h2d_copyPfS_i(float *, float *, int);
# 386 "cuda_main.cu"
...
if (((double)((__T20 = ((h_data[i]) - __cuda_local_var_75823_8_non_const_cpu)) , (__builtin_fabsf(__T20)))) > (9.999999999999999547e-07)) {
fprintf(stderr, ((const char *)"result doesn\'t match! pos : %d, gpu %f , cpu %f\n"), i, ((double)(h_data[i])), ((double)__cuda_local_var_75823_8_non_const_cpu));
...
void _Z8h2d_copyPfS_i( float *h_data,  float *d_data,  int len)
{
...
{  unsigned __T25;
 struct CUevent_st *__cuda_local_var_75998_14_non_const_startEvent;
# 388 "cuda_main.cu"
 struct CUevent_st *__cuda_local_var_75998_26_non_const_stopEvent;



 float *__cuda_local_var_76002_9_non_const_A;
 float *__cuda_local_var_76003_9_non_const_B;
 float *__cuda_local_var_76004_9_non_const_C;
# 405 "cuda_main.cu"
 float *__cuda_local_var_76015_9_non_const_d_A;
 float *__cuda_local_var_76016_9_non_const_d_B;
 float *__cuda_local_var_76017_9_non_const_d_C;
# 422 "cuda_main.cu"
 struct dim3 __cuda_local_var_76032_10_non_const_Blk_config;
 struct dim3 __cuda_local_var_76033_10_non_const_Grd_config;
# 436 "cuda_main.cu"
 float __cuda_local_var_76046_8_non_const_milliseconds;
# 389 "cuda_main.cu"
_Z5checkI9cudaErrorEvT_PKcS3_i((cudaEventCreate((&__cuda_local_var_75998_14_non_const_startEvent))), ((const char *)"cudaEventCreate(&startEvent)"), ((const char *)"cuda_main.cu"), 389);
_Z5checkI9cudaErrorEvT_PKcS3_i((cudaEventCreate((&__cuda_local_var_75998_26_non_const_stopEvent))), ((const char *)"cudaEventCreate(&stopEvent)"), ((const char *)"cuda_main.cu"), 390);




_Z5checkI9cudaErrorEvT_PKcS3_i((cudaMallocHost(((void **)(&__cuda_local_var_76002_9_non_const_A)), (((unsigned long)(rows * cols)) * 4UL))), ((const char *)"cudaMallocHost((void **)&A, rows * cols * FLT_SIZE)"), ((const char *)"cuda_main.cu"), 395);
_Z5checkI9cudaErrorEvT_PKcS3_i((cudaMallocHost(((void **)(&__cuda_local_var_76003_9_non_const_B)), (((unsigned long)cols) * 4UL))), ((const char *)"cudaMallocHost((void **)&B, cols * FLT_SIZE)"), ((const char *)"cuda_main.cu"), 396);
_Z5checkI9cudaErrorEvT_PKcS3_i((cudaMallocHost(((void **)(&__cuda_local_var_76004_9_non_const_C)), (((unsigned long)rows) * 4UL))), ((const char *)"cudaMallocHost((void **)&C, rows * FLT_SIZE)"), ((const char *)"cuda_main.cu"), 397);

_Z6init2DPfiif(__cuda_local_var_76002_9_non_const_A, rows, cols, (0.200000003F));
_Z6init1DPfif(__cuda_local_var_76003_9_non_const_B, cols, (0.1000000015F));
# 408 "cuda_main.cu"
_Z5checkI9cudaErrorEvT_PKcS3_i((cudaMalloc(((void **)(&__cuda_local_var_76015_9_non_const_d_A)), (((unsigned long)(rows * cols)) * 4UL))), ((const char *)"cudaMalloc((void **)&d_A, rows * cols * FLT_SIZE)"), ((const char *)"cuda_main.cu"), 408);
_Z5checkI9cudaErrorEvT_PKcS3_i((cudaMalloc(((void **)(&__cuda_local_var_76016_9_non_const_d_B)), (((unsigned long)cols) * 4UL))), ((const char *)"cudaMalloc((void **)&d_B, cols * FLT_SIZE)"), ((const char *)"cuda_main.cu"), 409);
_Z5checkI9cudaErrorEvT_PKcS3_i((cudaMalloc(((void **)(&__cuda_local_var_76017_9_non_const_d_C)), (((unsigned long)rows) * 4UL))), ((const char *)"cudaMalloc((void **)&d_C, rows * FLT_SIZE)"), ((const char *)"cuda_main.cu"), 410);

_Z8h2d_copyPfS_i(__cuda_local_var_76002_9_non_const_A, __cuda_local_var_76015_9_non_const_d_A, (rows * cols));
_Z8h2d_copyPfS_i(__cuda_local_var_76003_9_non_const_B, __cuda_local_var_76016_9_non_const_d_B, cols);
_Z8h2d_copyPfS_i(__cuda_local_var_76004_9_non_const_C, __cuda_local_var_76017_9_non_const_d_C, cols);

cudaEventRecord(__cuda_local_var_75998_14_non_const_startEvent, ((struct CUstream_st *)0LL));
# 422 "cuda_main.cu"
{
# 421 "/usr/local/cuda/include/vector_types.h"
(__cuda_local_var_76032_10_non_const_Blk_config.x) = 32U; (__cuda_local_var_76032_10_non_const_Blk_config.y) = 4U; (__cuda_local_var_76032_10_non_const_Blk_config.z) = 1U;
# 422 "cuda_main.cu"
}
{ __T25 = ((unsigned)((((rows / 2) + 4) - 1) / 4));
# 421 "/usr/local/cuda/include/vector_types.h"
{ (__cuda_local_var_76033_10_non_const_Grd_config.x) = 1U; (__cuda_local_var_76033_10_non_const_Grd_config.y) = __T25; (__cuda_local_var_76033_10_non_const_Grd_config.z) = 1U; }
# 423 "cuda_main.cu"
}

(cudaConfigureCall(__cuda_local_var_76033_10_non_const_Grd_config, __cuda_local_var_76032_10_non_const_Blk_config, 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z16kernel_sgemv_v1aiiiPKfS0_Pf(rows, cols, (((cols + 128) - 1) / 128), ((const float *)__cuda_local_var_76015_9_non_const_d_A), ((const float *)__cuda_local_var_76016_9_non_const_d_B), __cuda_local_var_76017_9_non_const_d_C));
# 433 "cuda_main.cu"
cudaEventRecord(__cuda_local_var_75998_26_non_const_stopEvent, ((struct CUstream_st *)0LL));
cudaEventSynchronize(__cuda_local_var_75998_26_non_const_stopEvent);

__cuda_local_var_76046_8_non_const_milliseconds = (0.0F);
cudaEventElapsedTime((&__cuda_local_var_76046_8_non_const_milliseconds), __cuda_local_var_75998_14_non_const_startEvent, __cuda_local_var_75998_26_non_const_stopEvent);
_ZNSolsEPFRSoS_E((_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((_ZNSolsEf((&_ZSt4cout), __cuda_local_var_76046_8_non_const_milliseconds)), ((const char *)" (ms)"))), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_);


if (_Z5checkPfS_ii(__cuda_local_var_76017_9_non_const_d_C, __cuda_local_var_76004_9_non_const_C, rows, cols)) {
printf(((const char *)"success!\n"));
}



if (__cuda_local_var_76002_9_non_const_A != ((float *)0LL)) { _Z5checkI9cudaErrorEvT_PKcS3_i((cudaFreeHost(((void *)__cuda_local_var_76002_9_non_const_A))), ((const char *)"cudaFreeHost(A)"), ((const char *)"cuda_main.cu"), 447); }
if (__cuda_local_var_76003_9_non_const_B != ((float *)0LL)) { _Z5checkI9cudaErrorEvT_PKcS3_i((cudaFreeHost(((void *)__cuda_local_var_76003_9_non_const_B))), ((const char *)"cudaFreeHost(B)"), ((const char *)"cuda_main.cu"), 448); }
if (__cuda_local_var_76004_9_non_const_C != ((float *)0LL)) { _Z5checkI9cudaErrorEvT_PKcS3_i((cudaFreeHost(((void *)__cuda_local_var_76004_9_non_const_C))), ((const char *)"cudaFreeHost(C)"), ((const char *)"cuda_main.cu"), 449); }

if (__cuda_local_var_76015_9_non_const_d_A != ((float *)0LL)) { _Z5checkI9cudaErrorEvT_PKcS3_i((cudaFree(((void *)__cuda_local_var_76015_9_non_const_d_A))), ((const char *)"cudaFree(d_A)"), ((const char *)"cuda_main.cu"), 451); }
if (__cuda_local_var_76016_9_non_const_d_B != ((float *)0LL)) { _Z5checkI9cudaErrorEvT_PKcS3_i((cudaFree(((void *)__cuda_local_var_76016_9_non_const_d_B))), ((const char *)"cudaFree(d_B)"), ((const char *)"cuda_main.cu"), 452); }
if (__cuda_local_var_76017_9_non_const_d_C != ((float *)0LL)) { _Z5checkI9cudaErrorEvT_PKcS3_i((cudaFree(((void *)__cuda_local_var_76017_9_non_const_d_C))), ((const char *)"cudaFree(d_C)"), ((const char *)"cuda_main.cu"), 453); } 
}

int main( int argc,  char **argv) {

 struct cudaDeviceProp __cuda_local_var_76068_17_non_const_prop;
_Z5checkI9cudaErrorEvT_PKcS3_i((cudaGetDeviceProperties((&__cuda_local_var_76068_17_non_const_prop), 0)), ((const char *)"cudaGetDeviceProperties(&prop, 0)"), ((const char *)"cuda_main.cu"), 459);
printf(((const char *)"Device: %s\n"), ((__cuda_local_var_76068_17_non_const_prop.name)));
# 477 "cuda_main.cu"
_Z8test_v1aii(1000, 1000);
_Z8test_v1aii(1000, 1000);
# 486 "cuda_main.cu"
return 0;
}
