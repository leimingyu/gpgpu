...
static __inline__ float _Z11__shfl_downfji(float, unsigned, int);
# 244 "cuda_main.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z16kernel_sgemv_v1aiiiPKfS0_Pf(const int, const int, const int, const float *__restrict__, const float *__restrict__, float *__restrict__);
...
# 246 "cuda_main.cu" 2
# 158 "/usr/local/cuda/include/sm_30_intrinsics.hpp"
static __inline__ float _Z11__shfl_downfji(
# 158 "/usr/local/cuda/include/sm_30_intrinsics.hpp"
float var,
# 158 "/usr/local/cuda/include/sm_30_intrinsics.hpp"
unsigned delta,
...
# 244 "cuda_main.cu"
__attribute__((global)) __attribute__((__used__)) void _Z16kernel_sgemv_v1aiiiPKfS0_Pf(
# 244 "cuda_main.cu"
const int rows,
# 245 "cuda_main.cu"
const int cols,
